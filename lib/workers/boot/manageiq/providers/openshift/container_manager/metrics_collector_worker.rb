...
require "vmdb/plugins/automate_domain"
...
require "extensions/ar_application_name"
...
# required for ManageIQ::Providers::ContainerManager
require "mixins/has_monitoring_manager_mixin"
...
require "manageiq/providers/kubernetes/container_manager/inventory_collections"
