module Ansible
  class Runner
    class Response
      ...
      def parse_stdout(stdout)
        ...
        stdout.each_line do |line|
          ...
          begin
            ...
            parsed_stdout << data if data.is_a?(Hash)
          rescue => e
      ...
      JOB_EVENT_GLOB = %w[artifacts result job_events *.json].freeze
      ...
      def load_stdout
        "".tap do |stdout|
          ...
          #
          job_event_files = Dir.glob(File.join(base_dir, *JOB_EVENT_GLOB))
